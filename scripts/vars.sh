...
NASM_VERSION="2.16.03"    # https://www.nasm.us/pub/nasm/releasebuilds/
...
X265_VERSION="4.0"        # https://bitbucket.org/multicoreware/x265_git/downloads/?tab=tags
VPX_VERSION="v1.15.0"      # https://chromium.googlesource.com/webm/libvpx
...
OPUS_VERSION="1.5.2"      # https://ftp.osuosl.org/pub/xiph/releases/opus/
AOM_VERSION="v3.10.0"      # https://aomedia.googlesource.com/aom
FFMPEG_VERSION="7.1"    # http://ffmpeg.org/releases/
...
if [ ${FFMPEG_VERSION} = "snapshot" ]; then
    PKG_VERSION="7.1.snapshot-1-codec-api-11"
fi
